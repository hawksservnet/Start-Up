<?php // fuel/app/views/template.php ?>
<!DOCTYPE html>
<html lang="ja"<?php echo ($page_id=="webgl" || $page_id=="webgl_modal")?' id="webgl-page"':''; ?>>
<!-- template -->
<head>
...
<?php
  ...
  $ua = new UserAgent();
  if($ua->set() === "mobile") {
    echo '<meta name="viewport" content="width=device-width,user-scalable=yes,initial-scale=1, maximum-scale=1, minimum-scale=1">';
...
<title><?php echo ($page_title!="")?$page_title."|":"Startup Hub Tokyo（スタートアップハブ東京）"; ?></title>

<!-- META -->
<link rel="apple-touch-icon-precomposed" sizes="57x57" href="<?php echo $url; ?>assets/img/common/_meta/apple-touch-icon-57x57.png" />
<link rel="apple-touch-icon-precomposed" sizes="60x60" href="<?php echo $url; ?>assets/img/common/_meta/apple-touch-icon-60x60.png" />
<link rel="apple-touch-icon-precomposed" sizes="72x72" href="<?php echo $url; ?>assets/img/common/_meta/apple-touch-icon-72x72.png" />
<link rel="apple-touch-icon-precomposed" sizes="76x76" href="<?php echo $url; ?>assets/img/common/_meta/apple-touch-icon-76x76.png" />
<link rel="apple-touch-icon-precomposed" sizes="114x114" href="<?php echo $url; ?>assets/img/common/_meta/apple-touch-icon-114x114.png" />
<link rel="apple-touch-icon-precomposed" sizes="120x120" href="<?php echo $url; ?>assets/img/common/_meta/apple-touch-icon-120x120.png" />
<link rel="apple-touch-icon-precomposed" sizes="144x144" href="<?php echo $url; ?>assets/img/common/_meta/apple-touch-icon-144x144.png" />
<link rel="apple-touch-icon-precomposed" sizes="152x152" href="<?php echo $url; ?>assets/img/common/_meta/apple-touch-icon-152x152.png" />
<link rel="icon" type="image/png" href="<?php echo $url; ?>assets/img/common/_meta/favicon-16x16.png" sizes="16x16" />
<link rel="icon" type="image/png" href="<?php echo $url; ?>assets/img/common/_meta/favicon-32x32.png" sizes="32x32" />
<link rel="icon" type="image/png" href="<?php echo $url; ?>assets/img/common/_meta/favicon-96x96.png" sizes="96x96" />
<link rel="icon" type="image/png" href="<?php echo $url; ?>assets/img/common/_meta/favicon-196x196.png" sizes="196x196" />
<meta name="application-name" content="&nbsp;"/>
<meta name="msapplication-TileImage" content="<?php echo $url; ?>assets/img/common/_meta/mstile-144x144.png">
...
<!-- SEO -->
<?php
  $page_description = "Startup Hub　Tokyoでは、起業を具体的に準備している人から、まだ検討段階の人まで、「これから起業しよう！」という思いを持っている人を手厚くサポートする施設です。";
  $page_keyword = ""
?>
...
<meta property="og:title" content="Startup Hub Tokyo（スタートアップハブ東京）" />
<meta property="og:description" content="<?php echo $page_description; ?>" />
<meta property="og:site_name" content="Startup Hub Tokyo（スタートアップハブ東京）" />
<meta property="og:image" content="<?php echo $url; ?>assets/img/common/_meta/ogp.png" />
<meta name="twitter:card" content="summary" />
<meta name="twitter:description" content="<?php echo $page_description; ?>" />
<meta name="twitter:title" content="<?php echo ($page_title!="")?$page_title."|":""; ?>Startup Hub Tokyo（スタートアップハブ東京）" />
<meta name="twitter:site" content="Startup Hub Tokyo（スタートアップハブ東京）" />
<meta name="twitter:image" content="<?php echo $url; ?>assets/img/common/_meta/ogp.png" />
<!-- SEO END -->
...
<script src="<?php echo $url; ?>assets/js/head.js"></script>

<link rel="stylesheet" type="text/css" href="<?php echo $url; ?>assets/css/style.css?<?php echo date('mdyGi');  ?>">
<?php //echo $extra_css; ?>
...
<body id="<?= $page_id ?>" class="lowlayer">
...
<div id="document" class="js__fullscreen">
    ...
    <div id="header-inner">
      ...
      <h1 id="site-logo-top">
        <div id="site-logo-inner">
          ...
          <svg x="0px"
             ...
             xml:space="preserve">
          <g>
            <title>Startup Hub Tokyo（スタートアップハブ東京）</title>
            <defs>
      ...
      <div id="head-navi-container" class="clearfix">
        <div id="gnavi-head" class="clearfix pc">
          ...
          <?php if(!Auth::check()): ?>
          <p class="mypage"><a href="<?= Uri::create("users/login"); ?>">MY PAGE</a></p>
          <?php else: ?>
          <p class="mypage min"><a href="<?= Uri::create("users/login"); ?>">MY PAGE</a></p>
          <p class="logout min"><a href="<?= Uri::create("users/logout"); ?>">LOGOUT</a></p>
          <?php endif; ?>
        ...
        <div id="head-navi-container-inner">
          <div id="head-navi-scroll">
            ...
            <nav id="gnavi">
              <ul class="clearfix">
                <li><a href="<?php echo $url.'vision/'; ?>"><span class="js__container"><span class="js__child">VISION</span></span></a></li>
                <li><a href="<?php echo $url.'service/'; ?>"><span class="js__container"><span class="js__child">SERVICE</span></span></a></li>
                <li><a href="<?php echo $url.'how_to_join/'; ?>"><span class="js__container"><span class="js__child">HOW TO JOIN</span></span></a></li>
                <li><a href="<?php echo $url.'pre-entre/'; ?>"><span class="js__container"><span class="js__child">PRE ENTRE</span></span></a></li>
                <li><a href="<?php echo $url.'facility-guide/'; ?>"><span class="js__container"><span class="js__child">FACILITYGUIDE</span></span></a></li>

                <li><a href="<?php echo $url.'event/'; ?>"><span class="js__container"><span class="js__child">EVENTS</span></span></a></li>
                <li><a href="<?php echo $url.'concierge/'; ?>"><span class="js__container"><span class="js__child">CONCIERGE</span></span></a></li>
                <li ><a href="<?php echo $url.'role-model/'; ?>"><span class="js__container"><span class="js__child">ROLE MODEL</span></span></a></li>
                <li><a href="<?php echo $url.'magazine/'; ?>"><span class="js__container"><span class="js__child">MAGAZINE</span></span></a></li>
                <li><a href="<?php echo $url.'access/'; ?>"><span class="js__container"><span class="js__child">ACCESS</span></span></a></li>
                <li><a href="<?php echo $url.'information/'; ?>"><span class="js__container"><span class="js__child">INFORMATION</span></span></a></li>

                <li><a href="<?php echo $url.'contact/'; ?>"><span class="js__container"><span class="js__child">CONTACT US</span></span></a></li>
              </ul>
            </nav><!-- /#gnavi -->
            ...
            <div class="js__container"><div class="js__child">
              <div class="btn min js__mark">
                <div class="btn-inner clear white">
                  <a href="<?php echo Uri::create("users/registration.php"); ?>">
      ...
      <?php if(!Auth::check()): ?>
      <p id="sp-mypage" class="sp"><a href="<?php echo Uri::create("users/login"); ?>">MY PAGE</a></p>
      <?php else: ?>
      <p id="sp-mypage" class="sp min">
        <a href="<?php echo Uri::create("users/login"); ?>" class="mypage"></a>
        <a href="<?= Uri::create("users/logout"); ?>" class="logout"></a>
      </p>
      <?php endif; ?>
  ...
  <!-- ページタイトル -->
  <?php if (!empty($page_title_inner_en)): ?>
  <h2 id="page-title" class="clearfix">
    <div class="page-title-inner">
      <span class="en"><?= $page_title_inner_en ?></span>
      <span class="jp"><?= $page_title_inner_jp ?></span>
    </div>
  </h2>
  <?php endif; ?>

  <!-- フラッシュ・メッセージ -->
  <?php if (Session::get_flash('success') || Session::get_flash('error')): ?>
  <div class="login-alert-box">
    <?php if (Session::get_flash('success')): ?>
     <div class="login-alert alert-success">
       <p>
       <strong><?php echo implode('</p><p>', e((array) Session::get_flash('success'))); ?></strong>
       </p>
     </div>
    <?php endif; ?>
    <?php if (Session::get_flash('error')): ?>
     <div class="login-alert alert-error">
       <p>
       <strong><?php echo implode('</p><p>', e((array) Session::get_flash('error'))); ?></strong>
       </p>
     </div>
    <?php endif; ?>
  </div>
  ...
  <div id="footer-container">
        <div id="footer-inner" class="clearfix">
            <ul class="footer-link clearfix">
                <li><a href="https://startuphub.tokyo/terms">利用規約</a></li>
                <li><a href="https://startuphub.tokyo/privacy-policy">プライバシーポリシー</a></li>
                <li><a href="https://startuphub.tokyo/site-policy">サイトポリシー</a></li>
                <li><a href="https://startuphub.tokyo/access">アクセス</a></li>
            </ul>
            <div class="text-wrap clearfix">
                ...
                <ul class="logo-container clearfix">
                    <li class="tokyoto-logo"><a href="http://www.metro.tokyo.jp/" target="_blank"><img src="<?php echo $url; ?>assets/img/common/tokyoto-logo.svg" alt="東京都"></a></li>
                    <li class="tokyoto-logo"><a href="http://www.tokyo-sogyo-net.jp/" target="_blank"><img src="<?php echo $url; ?>assets/img/common/tokyo_net_icon.svg" alt="東京創業NET"></a></li>
                </ul>
                ...
                <div class="text clearfix">
                    ...
                    <dl class="clearfix">
                        <dt>運営会社 : </dt>
                        <dd>テクノロジーシードインキュベーション株式会社</dd>
                    </dl>
                    <p>Startup Hub Tokyoは東京都からの委託を受けてテクノロジーシードインキュベーション株式会社が運営しています。</p>
                </div>
            </div>
...
<script src="<?php echo $url; ?>assets/js/app.js?<?php echo date('mdyGi');  ?>"></script>
<?php //echo $extra_js; ?>
<?php if (!empty($extra_js)) echo Asset::js($extra_js); ?>
<script>
