...
return array(
	...
	'defaults' => array(
		 ...
		 * Email charset
		 */
		//ここで文字コード指定をしてるのにもかかわらず、本文は手動でエンコードしてからbody()関数に送らないとなぜか文字化けするクライアントがでる
		'charset' => 'utf-8',
		 ...
		 * SMTP settings
		 */
		// http://fuelphp.com/docs/packages/email/troubleshooting.html
		// 'smtp' => array(
		// 	'host'      => 'ssl://smtp.gmail.com',
		// 	'port'      => 465,
		// 	'username'  => 'info@wan.or.jp',
		// 	'password'  => 'anchovies',
		// 	'timeout'   => 5,
		// 	'starttls'  => false,
		// ),
