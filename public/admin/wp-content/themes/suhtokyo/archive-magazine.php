...
-->
                    ...
                    $path = $keys['path'];
                    $param = $keys['query'];
                    $path = (strpos($path,'/page/') !== false)? str_replace('page/'.end(explode("/", $path)), '', $path):$path;
                    $term = str_replace("post_type=",'',$param);
                    $magazines = get_categories(array('taxonomy'=>'magazines'));//エリア取得
                    ?>
                                <li class="current"><a href="<?php echo home_url('/magazine/'); ?>" class="en">ALL</a></li>
                    <?php
                    foreach ($magazines as $key => $magazine):
                    $magazinename = $magazine->name; ?>
                                <li><a href="<?php echo home_url('/magazines/'); ?><?php echo $magazine->slug; ?>/" <?php echo ($term==$magazine->slug)?'class="current jp"':'class="jp"'; ?> ><?php echo $magazinename; ?></a></li>
                    <?php endforeach; ?>
                            </ul>
                        </div>
                    </nav>
